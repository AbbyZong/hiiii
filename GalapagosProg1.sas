...
TITLE "First SAS program: Galapagos biodiversity data";
...
SYMBOL1 VALUE=dot CV=blue; /*change axis label and dot colors*/
...
SET Galapagos;  /*save galapagos into the desired file*/
RUN;

DATA STAT0023.Galapagos;INFILE "galapagos.dat" FIRSTOBS=2;
INPUT Island $ Species Endemics Area Elevation Nearest Scruz Adjacent;
RUN; /*read galapagos directly into the desired file*/
